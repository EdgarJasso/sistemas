...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2020 a las 21:59:02
...
(3, 1, 1, 'Edgar Jasso', 'pendiente', 3, 4, 'Autoevaluacion', '2020-2'),
...
--
ALTER TABLE `ecsnts_area`
  MODIFY `id_area` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `ecsnts_contesto`
  MODIFY `id_campo` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `ecsnts_pregunta`
--
ALTER TABLE `ecsnts_pregunta`
  MODIFY `id_pregunta` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `ecsnts_respuestas`
--
ALTER TABLE `ecsnts_respuestas`
  MODIFY `id_respuesta` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `ecsnts_validacion`
  MODIFY `Id_validacion` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
