...
<div class="row"> 
 ...
 <center>
     <h2>Usuarios</h2>
  	...
  	<button  type="button" class="btn btn-primary btn-sm boton-add color-p" data-toggle="modal" data-target="#Agregar_Usuario" id="boton_add"><span class="icon-plus"></span> Nuevo</button>
	...
	<?php 
      ...
      try {
        $database = new Connection();
         $db = $database->open();
          $query="SELECT * FROM tkd_usuarios";
                ...
                <div class="btn-group">
                 ...
                 <div class="dropdown-menu box">
				  ...
				  <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                   data-target="#Ver_Usuario" onclick="AgregarView('<?php echo $datos?>')"><span class="icon-eye"></span></button>
				  ...
				  <button type="button" class="btn btn-danger btn-sm" onclick="preguntarUsuario(<?php echo $row['id_usuario'] ?>)"><span class="icon-cross"></span></button>
				 </div>
                </div>  
               </center>
              </td>
